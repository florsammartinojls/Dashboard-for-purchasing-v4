...
const DEFAULT_GL = [
  ...
  { term: "Shape Normalization", desc: "projectedDSR = currentDSR × shape[M] ÷ shape[currentMonth]. Example: if I sell 76/day now in March (shape 0.99), and May has shape 1.71, then May = 76 × (1.71/0.99) = 131/day. This says 'May historically sells 1.73× what March sells'. No double-counting of growth." },
