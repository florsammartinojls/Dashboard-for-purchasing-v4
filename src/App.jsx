...
export default function App() {
  ...
  const goCore = useCallback(id => { setPrevTab(tab); setCoreId(id); setTab("core"); clearSum() else { setPrevTab(tab); setCoreId(id); setTab("core") } }, [tab]);
  const goBundle = useCallback(id => { setPrevTab(tab); setBundleId(id); setTab("bundle"); clearSum() else { setPrevTab(tab); setBundleId(id); setTab("bundle") } }, [tab, panelCoreId]);
