...
// Positive % = USA more expensive than China → red
            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="text-gray-500 uppercase border-b border-gray-700">
                  ...
                  <th className="py-1.5 text-right" title="Effective DSR from v3 engine">effDSR</th>
                  ...
                  <th className="py-1.5 text-right" title="China ETA + pipeline_days">Cover need</th>
                  <th className="py-1.5 text-right">Gap (pcs)</th>
                  <th className="py-1.5 text-right">Gap (DOC)</th>
                  <th className="py-1.5 text-right" title="Pieces of THIS core consumed by this bundle's gap">Core qty</th>
                </tr>
              </thead>
              <tbody>
            ...
            <table className="w-full text-xs">
              <thead className="bg-gray-900 border-b border-gray-700">
                <tr className="text-gray-500 uppercase">
                  ...
                  <th className="py-2 px-3 text-right" title="Pieces to buy from USA">Buy (pcs)</th>
                  <th className="py-2 px-3 text-right" title="DOC of bridge cover this purchase adds">DOC added</th>
                  <th className="py-2 px-3 text-left">USA vendor</th>
                  <th className="py-2 px-3 text-right" title="Δ vs last China price">Δ vs China</th>
