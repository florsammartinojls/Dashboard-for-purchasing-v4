...
export default function CoreTab({ data, stg, hist, daily, coreId, onBack, goBundle }) {
  ...
  const cHF = cH; // Include current month
  ...
  const bSHF = bSH; // Include current month
  ...
  return <div className="p-4 max-w-7xl mx-auto">
    ...
    {/* Bundles — new column order: JLS, Title, %28d, FIB DOC, FBA DOC, C.DSR, GP, AICOGS, Margin, Raw, Batched, SC, PPRC, Replen | LT Rev, LT Prof */}
